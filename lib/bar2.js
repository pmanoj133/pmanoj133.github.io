...
var barTooltip = d3.select("#bar2")
        ...
        var barMousemove = function(d) {
          barTooltip
            .html("Country:<strong>" + d.key + "</strong><br>  Happiness Score:" + d3.format(".2f")(d.value) +"</strong>")
  ...
  var mousemove = function(d) {
    tooltip
      .html("Country: <strong>" + d.key + " </strong> <br> GINI index of household:<strong>" + d3.format("0.2f")(d.value) + "</strong>" )
      .style("left", (d3.event.pageX + 15) + "px")
      .style("top", (d3.event.pageY - 28) + "px")
      .style("left", (d3.mouse(this)[0]+90) + "px") // It is important to put the +90: other wise the tooltip is exactly where the point is an it creates a weird effect
      .style("top", (d3.mouse(this)[1]) + "px")
  ...
  svg.append('g')
    ...
    svg.append('g').selectAll("text")
       ...
       .text("Happiness score not having a strong relationship with Household inequality")
       .attr("x", function(d) { return x('Sri Lanka'); })
       .attr("y", function(d) { return y(7.5); })
       .attr("fill", "black");
