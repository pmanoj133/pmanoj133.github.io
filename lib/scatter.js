...
d3.csv("data/scatter.csv", function(data) {
  ...
  svg.append('g')
    ...
    svg.selectAll("text")
       ...
       .text((d) => "Country with lowest AvgLogGDP and lowest happiness score")
       .attr("x", function(d, i) { return x(d.AvgLogGDP)+5; })
       .attr("y", function(d, i) { return y(d.AvgHappinessScore); })
