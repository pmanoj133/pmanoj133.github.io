...
var barTooltip = d3.select("#bar1")
        ...
        var barMousemove = function(d) {
          barTooltip
            .html("Country:<strong>" + d.key + "</strong><br>  Happiness Score:<strong>" + d3.format("0.2f")(d.value) +"</strong>")
  ...
  var mousemove = function(d) {
    tooltip
      .html("Country: <strong>" + d.key + " </strong> <br>  Average Life Expectancy at Birth:<strong>" + d3.format("0.2f")(d.value) + "</strong>" )
      .style("left", (d3.event.pageX + 15) + "px")
      .style("top", (d3.event.pageY - 28) + "px")
      .style("left", (d3.mouse(this)[0]+90) + "px") // It is important to put the +90: other wise the tooltip is exactly where the point is an it creates a weird effect
      .style("top", (d3.mouse(this)[1]) + "px")
  ...
  svg.append('g')
    ...
    svg.append('g').selectAll("text")
       .data(data.filter(function(d){return d.country == 'Central African Republic';}))
       .enter()
       .append("text")
       // Add your code below this line
       .text("Happiness score approx. decreasing with decreasing Life Expectancy at Birth")
       .attr("x", function(d) { return x('Brazil'); })
       .attr("y", function(d) { return y(8); })
       .attr("fill", "black");
