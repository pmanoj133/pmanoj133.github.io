...
d3.csv("data/bar1.csv", function(data) {
  ...
  svg.selectAll("bar1")
    ...
    .append("rect")
      ...
      .on("barMouseover", mouseover )
      .on("barMousemove", mousemove )
      .on("barMouseleave", mouseleave )
  ...
  var mousemove = function(d) {
    tooltip
      .html("Country: <strong>" + d.key + " </strong> <br>  Average Life Expectancy at Birth:<strong>" + d.value + "</strong>" )
